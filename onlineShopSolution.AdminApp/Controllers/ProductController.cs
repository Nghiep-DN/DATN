...
namespace onlineShopSolution.AdminApp.Controllers
{
    public class ProductController : BaseController
    {
        ...
        public async Task<IActionResult> Index(string keyword, int? categoryId,int pageIndex = 1, int pageSize = 5)
        {
            ...
            return View(data);
            //return Json(new { data = data, mess = "success." });
        }
        [HttpGet]
        ...
        public async Task<IActionResult> Create([FromForm] ProductCreateRequest request)
        {
            ...
            ModelState.AddModelError("", "Create product unsuccessfully.");
            return View(request);
        }

        //[HttpGet]
        //public async Task<IActionResult> Details(Guid id,string languageId)
        //{
        ...
        public async Task<IActionResult> Edit(int id)
   {
        ...
        public async Task<IActionResult> CategoryAssign(CategoryAssignRequest request)
        {
            ...
            {
                TempData["result"] = "Update category assign successfully.";
                return RedirectToAction("Index");
            }
        ...
        public async Task<IActionResult> Delete(ProductDeleteRequest request)
        {
            ...
            ModelState.AddModelError("", "Delete unsuccessfully.");
            return View(request);
        }

        #region private GetCategoryAssignRequest
