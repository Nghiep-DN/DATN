        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 3, 6, 18, 2, 9, 740, DateTimeKind.Local).AddTicks(9867)),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoDesciption = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "f90eaff6-d67e-417f-ab9f-054c64ec5e73", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "9c4d61e6-c734-45d8-b76f-d3bcb020f15e", new DateTime(1999, 12, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "nghiepdo.dev@gmail.com", true, "Nghiep", "Do", false, null, "nghiepdo.dev@gmail.com", "admin", "AQAAAAEAACcQAAAAEC98GkYzGSxW0mey/EjEQa9XkrO3RrwzCjtmw57TN8E3t/VnsQjZe8/8mKNVY/ccCw==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 3, 6, 18, 2, 9, 763, DateTimeKind.Local).AddTicks(294), 150000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi", "Áo nam", "ao-nam", "Sản phẩm thời trang cho nam ", "Sản phẩm thời trang cho nam " },
                    { 3, 2, "vi", "Áo nữ", "ao-nu", "Sản phẩm thời trang cho nữ ", "Sản phẩm thời trang cho nữ " },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Hàng Việt Nam xuất khẩu", "Sản phẩm bán chạy tại Owen", "vi", "Áo sơ mi trắng Owen cho nam", 1, "ao-so-mi-trang-owen-cho-nam", "Sản phẩm thời trang cho nam 2020", "Sản phẩm thời trang cho nam 2020" },
                    { 2, "Made in Vietnam", "Top hot for men at Owen", "en", "T-Shirt Owen for men ", 1, "t-shirt-owen-for-men", "T-shirt product for men 2020", "T-shirt product for men 2020" }
                });
